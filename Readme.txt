...
3) right after 2 completes execution, rose.js should be run as "node rose.js" to geneate the hits files: theHTML.html & theHits.json;
4) tire.js should be called in order to return the HTML for most recent hits.
